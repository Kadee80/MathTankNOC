  ...
  void addParticle() {
   ...
   CParticle oldP = particles.get(r);
    ...
    if (numCon >3) {
      ...
      CParticle newP = new CParticle(oldP.x+dir.x, oldP.y+dir.y, thickness/2, jointSize, podSize);
      particles.add(newP);
      //add repulsion
      ...
      CSpring s = new CSpring(newP, oldP, len, .2, thickness);
